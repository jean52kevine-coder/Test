...
const ShaderBackground = ({ className }: ShaderBackgroundProps) => {
  ...
  const fsSource = `
    ...
    const vec4 lineColor = vec4(0.11, 0.73, 0.33, 1.0);
    ...
    void main() {
      ...
      vec4 lines = vec4(0.0);
      vec4 bgColor1 = vec4(0.03, 0.08, 0.06, 1.0);
      vec4 bgColor2 = vec4(0.04, 0.16, 0.11, 1.0);
  ...
  const initShaderProgram = (gl: WebGLRenderingContext, vertex: string, fragment: string) => {
