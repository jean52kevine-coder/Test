              ...
              "--gradient":
                variant === "white"
                  ? `repeating-conic-gradient(
                      ...
                      hsl(0 0% 40% / 0) calc(100% / var(--repeating-conic-gradient-times)),
                      hsl(0 0% 100% / 0.8) calc(200% / var(--repeating-conic-gradient-times))
                    )`
                  : `repeating-conic-gradient(
                      from calc(var(--start) * 1deg),
                      hsl(145 63% 42% / 0.8) 0%,
                      hsl(145 63% 50% / 0.6) calc(100% / var(--repeating-conic-gradient-times)),
                      hsl(145 63% 30% / 0) calc(100% / var(--repeating-conic-gradient-times)),
                      hsl(145 63% 42% / 0.8) calc(200% / var(--repeating-conic-gradient-times))
                    )`,
